...
public interface ResourceDao {
	...
	@Results(id = "resourceResult", 	value = { 
			...
			javaType = List.class, 
			many = @Many(select = "com.farsight.huagang.moduls.account.dao.UserRoleDao.selectRolesByResourceId")) })
	...
	@Update("update m_resource set resource_uri=#{resourceUri},resource_name=#{resourceName},permission=#{permission} "
